...
<div class="flex mb-3 justify-center">
    <h1 class="flex flex-col justify-center text-w scale-text-large font-semibold">Climb State</h1>
</div>
...
<div class="flex justify-evenly">
    ...
    <div class="flex flex-col justify-center w-1/3">
        <label for="ParkHang" class="text-center text-w scale-text font-semibold">Shallow</label>

        <input name="parkHang" id="ParkHang" type="radio" value={EndClimb.Shallow}
        class="mx-auto testcheck:tog checked:bg-active bg-inactive"
        bind:group={$scoutingData.endClimb}/>
    </div>
</div>
...
<div class="flex flex-col justify-center w-1/3">
    <label for="ParkHang" class="text-center text-w scale-text font-semibold">Deep</label>

    <input name="parkHang" id="ParkHang" type="radio" value={EndClimb.Deep}
    class="mx-auto testcheck:tog checked:bg-active bg-inactive"
    bind:group={$scoutingData.endClimb}/>
</div>
<!-- 
